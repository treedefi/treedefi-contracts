...
contract TreePool is TokenRecover {
    ...
    struct UserInfo {
        ...
        uint256 stakedOn;   // Staking time in unix timestamp 
    }
    ...
    uint256 public lockingPeriodInSeconds;
    ...
    function withdraw(uint256 _amount) public {
        ...
        require(
            user.stakedOn.add(lockingPeriodInSeconds) <= block.timestamp,
    ...
    function setLockingPeriod(uint256 _lockingPeriodInSeconds) public onlyOwner {
        lockingPeriodInSeconds = _lockingPeriodInSeconds;
    } 
